<div align="center">
  <br />
    <a href="#" target="_blank">
      <img src="./public/moodflix-cover.png" alt="Project Banner">
    </a>
  <br />
  ...
  <h3 align="center">Moodflix | React.js Movies Application</h3>

   <div align="center">
     Moodflix is a simple React.js application that uses The Movie Database API to fetch and search recent movies.
    </div>
</div>
...
```bash
git clone https://github.com/Damjan15/moodflix
cd moodflix
```
